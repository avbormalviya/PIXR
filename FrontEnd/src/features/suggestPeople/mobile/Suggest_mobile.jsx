                ...
                <div className={style.card_wrapper}>
                    {
                        suggestedUsers?.map((user, index) => (
                            <FollowUserCard key={ index } styles={style.usercard} fullName={ user.fullName } userName={ user.userName } profilePic={ user.profilePic } isFollower={ user.isFollower } />
                        ))
                    }
                </div>
            </section>

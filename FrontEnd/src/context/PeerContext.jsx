...
export const PeerProvider = ({ children }) => {
    ...
    const initiateCall = (chatUserId, InitUserId) => {
        ...
        setCalling(true);
        setInitiator(true);
        startPeerConnection(chatUserId, true); // Set initiator explicitly
    ...
    const acceptCall = () => {
        ...
        startPeerConnection(callerId, false); // Set as callee (not initiator)
    ...
    const startPeerConnection = async (user, isInitiator) => {
        try {
